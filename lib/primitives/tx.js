...
/**
 * Set the `floData` for a particular transaction
 * @param {String} data - the `floData` you want in String form.
 */
TX.prototype.setFloData = function setFloData(data) {
  this.strFloData = data
}
